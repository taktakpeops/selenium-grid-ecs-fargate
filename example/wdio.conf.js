exports.config = {
    ...
    //
    hostname: 'SeleniumGrid-1176756584.us-east-1.elb.amazonaws.com',
    port: 4444,
    path: '/wd/hub',
    //
    ...
    capabilities: [{
        ...
        'goog:chromeOptions': {
            args: ['--no-sandbox', '--disable-setuid-sandbox', '--headless', '--whitelisted-ips', '--disable-dev-shm-usage', '--maximized'],
        },
    }],
    //
    // ===================
